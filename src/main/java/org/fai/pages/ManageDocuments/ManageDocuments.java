...
public class ManageDocuments extends BasePage{
	...
	public String dragAndDrop(String fromloca, String moveTo, String direction) throws InterruptedException, AWTException {
		Thread.sleep(5000);
	    ...
	    ExplicitWaitConditions.performExplicitWait(alert, ExplicitWaitExpextecConditions.PRESENSCE);
	    String alertMsg = getText(alert, ExplicitWaitExpextecConditions.PRESENSCE);
